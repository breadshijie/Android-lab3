...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_paper = findViewById(R.id.button_paper);
        btn_scissor = findViewById(R.id.button_scissor);
        btn_stone = findViewById(R.id.button_stone);
        btn_mora = findViewById(R.id.button_mora);
